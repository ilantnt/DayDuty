...
var LogEntries = /*#__PURE__*/function (_Component) {
  _inherits(LogEntries, _Component);

  var _super = _createSuper(LogEntries);
  ...
  function LogEntries() {
    ...
    _defineProperty(_assertThisInitialized(_this), "highlight", function (index) {
  ...
  _createClass(LogEntries, [{
    ...
    value: function render() {
      ...
      var componentNameWidth = 2 + Math.max.apply(Math, _toConsumableArray(this.props.entries.map(function (_ref) {
      ...
      }, this.props.entries.map(function (_ref2, i) {
